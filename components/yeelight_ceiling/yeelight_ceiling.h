...
class YeelightCeiling : public light::LightOutput {
 public:
  void set_cold_white(output::FloatOutput *cold_white) { this->cold_white_output_ = cold_white; }
  void set_warm_white(output::FloatOutput *warm_white) { this->warm_white_output_ = warm_white; }
  void set_night_light(output::FloatOutput *night_light) { this->night_light_output_ = night_light; }
  ...
  void set_night_light_brightness_threshold(float brightness) { this->night_light_brightness_threshold_ = brightness; }
  void set_night_light_turn_off_delay(uint32_t delay) { this->night_light_turn_off_delay_ = delay; }
 ...
 protected:
  ...
  bool is_night_light_turn_on_{false};
